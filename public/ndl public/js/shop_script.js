...
(function () {
    ...
    /////////////////////////////////////////  URL handler Start ///////////////////////////////////////////////////
    const _urls = {
        "template_searchUrl": admin_url + "admin/template1",
    };
    ...
    api.prototype.templateSearch = function (value) {
        ...
        $.ajax({
            url: shop.url.get("template_searchUrl"),
    ...
    plugin.prototype.init = function () {
        ...
        $("form[name='ndl-shop-form']").validate({
        ...
        $("form[name='ndl-shop-update-form']").validate({
    ...
    shop.events = Object.create(events.prototype);
    shop.html = Object.create(html.prototype);
    shop.api = Object.create(api.prototype);
    shop.plugin = Object.create(plugin.prototype);
    shop.url = Object.create(url.prototype);
