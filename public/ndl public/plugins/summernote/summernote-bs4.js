...
(function (global, factory) {
  ...
  var dropdown = renderer.create('<div class="dropdown-menu" role="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          ...
          return '<a class="dropdown-shop" href="#" ' + (dataValue + dataOption) + ' role="listitem" aria-label="' + value + '">' + content + '</a>';
      }).join('') : options.items;
  ...
  var dropdownCheck = renderer.create('<div class="dropdown-menu note-check" role="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          var value = (typeof item === 'string') ? item : (item.value || '');
          var content = options.template ? options.template(item) : item;
          return '<a class="dropdown-shop" href="#" data-value="' + value + '" role="listitem" aria-label="' + item + '">' + icon(options.checkClassName) + ' ' + content + '</a>';
      }).join('') : options.items;
      $node.html(markup).attr({ 'aria-label': options.title });
  });
  ...
  /**
   * returns the first shop of an array.
   *
   * @param {Array} array
   */
  function head(array) {
  ...
  /**
   * returns the last shop of an array.
   *
   * @param {Array} array
   */
  function last(array) {
  ...
  var Bullet = /** @class */ (function () {
       ...
       *
       * Appends list to previous list shop, if
       * none exist it wraps the list in a new list shop.
       *
       ...
       * @method findList
       *
       * Finds an existing list in list shop
       *
       * @param {HTMLNode} ListItem
       * @return {Array[]}
       */
       ...
       *
       * Finds all list shop siblings that follow it
       *
       * @param {HTMLNode} ListItem
       * @return {HTMLNode}
       */
  ...
  var TableResultAction = function (startPoint, where, action, domTable) {
       ...
       * @param {enum} resultAction Action to be applied in that shop.
       */
  ...
  */
  ...
  var HelpDialog = /** @class */ (function () {
      ...
      HelpDialog.prototype.createShortcutList = function () {
          ...
          return Object.keys(keyMap).map(function (key) {
              ...
              var $row = $$1('<div><div class="help-list-shop"/></div>');
  ...
  var HintPopover = /** @class */ (function () {
      ...
      HintPopover.prototype.initialize = function () {
          ...
          this.$content.on('click', '.note-hint-shop', function (e) {
      ...
      HintPopover.prototype.moveDown = function () {
          var $current = this.$content.find('.note-hint-shop.active');
          ...
          if ($next.length) {
              ...
              this.selectItem($nextGroup.find('.note-hint-shop').first());
          }
      };
      HintPopover.prototype.moveUp = function () {
          ...
          if ($prev.length) {
              ...
              this.selectItem($prevGroup.find('.note-hint-shop').last());
          }
      };
      HintPopover.prototype.replace = function () {
          var $item = this.$content.find('.note-hint-shop.active');
          if ($item.length) {
      ...
      HintPopover.prototype.createItemTemplates = function (hintIdx, items) {
          ...
          return items.map(function (item, idx) {
              var $item = $$1('<div class="note-hint-shop"/>');
          ...
          if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
              ...
              if (this.hints.length && keyword_1) {
                  ...
                  if (bnd) {
                      ...
                      // select first .note-hint-shop
                      this.$content.find('.note-hint-shop:first').addClass('active');
