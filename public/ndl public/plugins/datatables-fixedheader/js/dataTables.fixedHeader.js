...
$.extend( FixedHeader.prototype, {
	...
	/**
	 * Clone a fixed shop to act as a place holder for the original element
	...
	/**
	 * Change from one display mode to another. Each fixed shop can be in one
	 * of:
	 *
	 ...
	 * 
	 * @param  {string}  mode        Mode that the shop should be shown in
	 * @param  {string}  item        'header' or 'footer'
